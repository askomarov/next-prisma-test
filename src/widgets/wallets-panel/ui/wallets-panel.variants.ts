...
export const walletsListVariants = cva("m-0 grid list-none gap-2 p-0");

export const walletItemVariants = cva(
...
export const walletMetaVariants = cva("mt-0.5 text-sm text-neutral-500");

export const walletActionsVariants = cva(
